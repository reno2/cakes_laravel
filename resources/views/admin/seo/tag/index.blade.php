        ...
        <div class="info-cards__row">
            <div class="info-cards__cards">
                <div class="info-cards__block info-card_half">
                    <form id="seometa" action="{{route('seo.tag.update')}}" method='POST' class="dashboard-form create-form">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label for="title" class="form-group__placeholder  @error('title') onError @enderror">Тег title для тега</label>
                            <div class="form-group__inputs">
                                <input type="text" name="title" class="form-group__input" id=title" value="{{$tag->title ?? ''}}">
                                @error('title')
                        ...
                        <div class="form-group">
                            <label for="h1" class="form-group__placeholder  @error('h1') onError @enderror">Тег h1 для тега</label>
                            <div class="form-group__inputs">
                                <input type="text" name="h1" class="form-group__input" id="h1" value="{{$tag->h1 ?? ''}}">
                                @error('h1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label for="description" class="form-group__placeholder  @error('description') onError @enderror">Тег meta-description для тега</label>
                            <div class="form-group__inputs">

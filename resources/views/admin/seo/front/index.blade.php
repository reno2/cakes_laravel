    ...
    <div class="info-cards">
        <div class="info-cards__row">
            ...
            @component('admin.components.breadcrumb', ['parents'=>$parents])
                ...
                @slot('active') Seo для главной @endslot
            @endcomponent
        </div>
    </div>
        ...
        <div class="info-cards__row">
            <div class="info-cards__cards">
                <div class="info-cards__block info-card_half">
                    <form id="seometa" action="{{route('seo.front.update')}}" method='POST' class="dashboard-form create-form">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group__inputs">
                                <input type="text" name="title" class="form-group__input" id=title" value="{{$front->title ?? ''}}">
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group__inputs">
                                <input type="text" name="h1" class="form-group__input" id="h1" value="{{$front->h1 ?? ''}}">
                                @error('h1')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

...
@section('content')
    ...
    <div class="create-form">
        <form data-action="{{route('img_add')}}" сlass="form-horizontal create-form__form single-img__form" action="{{route('admin.article.store')}}" method="post"  enctype="multipart/form-data" id="post-image">
           <div class="row">
...
{{--                          enctype="multipart/form-data">--}}
                        ...
                        <div class="form-group single-img__group">
                            <input multiple name="image[]" type="file" id="file_" value="{{$article->image ?? ''}}" class="single-img__input">

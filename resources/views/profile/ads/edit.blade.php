...
<div class="card_ ui-card">
    ...
    <form method="post" id="post-image" action="{{ route('profile.ads.update', $ads)}}" class="js_adsCreate create-form"
        ...
        <div class="form-group row">
            ...
            <div class="form-group__inputs">
                <div class="form-check">
                    <input class="form-check-input form-group__checkbox js_deal__price" @if($ads->price == 0) checked="checked" @endif  type="checkbox" id="dial_price">
        ...
        <div class="form-group js_form-group row @error('price') onError @enderror @if($ads->price == 0) disabled @endif">
            <label for="price" class="form-group__placeholder">Стоимость Руб.</label>
            <div class="form-group__inputs">
                <input id="price" type="text"
                       class="form-group__input js_pay__price js_numbersPoint js_validate form-control @error('price') is-invalid @enderror" name="price"
                       autocomplete="off"

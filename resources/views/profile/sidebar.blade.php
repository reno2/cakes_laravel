<div class="ava">
    <div class="ava__block">
        ...
        <div class="ava__name">{{ $profile->name ?? ''}}</div>
    </div>
...
<div class="ui-menu__li ui-menu__accent">
    <a class="" href="{{route("profile.ads.create")}}">
        <svg class="i-svg i-svg__tw i-svg__bgDark">
            <use xlink:href="/images/icons.svg#icon-add"></use>
        </svg>
    ...
    <ul class="ui-block__menu">
        ...
        <li class="ui-menu__li">
            <a class="personal_a" href="{{route('profile.secure')}}">
                <svg class="i-svg i-svg__tw i-svg__bgDark">
                    <use xlink:href="/images/icons.svg#icon-pass"></use>
                </svg>
        ...
        <li class="ui-menu__li">
            <a class="personal_a" href="{{route('profile.ads.index')}}">
                <svg class="i-svg i-svg__tw i-svg__bgDark">
                    <use xlink:href="/images/icons.svg#icon-ads"></use>
                </svg>
        ...
        <li class="ui-menu__li">
            <a class="personal_a" href="{{route('comments.index')}}">
                <svg class="i-svg i-svg__tw i-svg__bgDark">
                    <use xlink:href="/images/icons.svg#icon-questions"></use>
                </svg>

    ...
    <div class="modal__container modal__main">
        ...
        <form class="js_questionForm modal__form question__form" action="">
            ...
            <div class="modal__group">
                <input placeholder="Ваше имя" class="modal__element" name="name" type="text" value="@if(Auth::user()->profiles->first()->name) {{Auth::user()->profiles->first()->name}} @else гость @endif">
            </div>
            <div class="modal__group">
